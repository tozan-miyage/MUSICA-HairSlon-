...
function add_files()
{
    ...
    wp_enqueue_style('swiper.css', get_template_directory_uri() . '/css/swiper.css', array('swiper.min.css'), null, false);
    ...
    wp_enqueue_script('swiper.js', get_template_directory_uri() . '/js/swiper.js', array('swiper.bundle.min.js'), null, true);
